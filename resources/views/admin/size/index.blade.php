            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="button-list">
                        <!-- Full width modal -->
                        <button type="button" class="btn btn-primary btn-show-modal">Thêm mới kích cỡ</button>
                    </div>
                </div> <!-- end card-body -->
                <div class="card-body">
                    <div id="basic-datatable_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                        <div class="row">
                            <table
                                ...
                                <tbody class="table-data" data-route="{{route('size.list')}}">
